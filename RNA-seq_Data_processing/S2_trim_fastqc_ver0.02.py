...
for f1 in raw_file:
    ...
    # 1-2 cutadapt commands for pruning according to adapter files
    # 3-4 cutadapt commands for trimming poly A/T/G, sequences >=30 A/T/G will be cut off
    # repair.sh repairs the trimmed sequencing file
    # Finally, FastQC was used to evaluate the quality of the data after quality control
    os.system('''
